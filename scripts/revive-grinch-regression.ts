...
assert(source.includes("case 'Decapitate': damage *= 1.5; break"), 'Shuten 1.5x Decapitate nerf missing')
...
console.log('Grinch one-use, current Shuten, and full Pandora pool guards passed.')
